...
class ImportTask(webapp.RequestHandler):
	def get(self):
		...
		menu_annuaire_des_sites = Menu(name="Annuaire des sites", special_kind="annuaire_des_sites").put()
